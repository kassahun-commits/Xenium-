"""
Proportional Venn diagram — Chromatin AW Upregulated proteins (NO LABELS)
========================================================================
Labels-off twin of make_venn_chromatin_AW_up_proportional.py:
identical circles, colors, and region counts, but no set labels,
no title, and no footnote (for figure assembly in Illustrator).

Output: Venn_Chromatin_AW_Up_Proportional_nolabels.pdf / .png
"""
...
OUT_PDF = os.path.join(SCRIPT_DIR, 'Venn_Chromatin_AW_Up_Proportional_nolabels.pdf')
OUT_PNG = os.path.join(SCRIPT_DIR, 'Venn_Chromatin_AW_Up_Proportional_nolabels.png')
