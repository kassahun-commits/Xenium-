...
OUT_PDF  = os.path.join(SCRIPT_DIR, 'Translocation_Union_byCondition_heatmap_p10_fc1.pdf')
OUT_PNG  = os.path.join(SCRIPT_DIR, 'Translocation_Union_byCondition_heatmap_p10_fc1.png')
...
print(f'Union proteins: {len(df_union)}')
...
cb.set_ticks([-1.0,-0.5,0,0.5,1.0]); cb.ax.tick_params(labelsize=7)
...
fig.text(0.5, (FIG_H-TOP_PAD*0.35)/FIG_H,
         f'Protein Translocation — Chromatin & SN by Condition  (n = {n_prot})  [p < 0.10 | FC scale ±1]',
