...
OUT_PDF  = os.path.join(SCRIPT_DIR, 'Translocation_TrueUnion_byCondition_heatmap_p10_fc1.pdf')
OUT_PNG  = os.path.join(SCRIPT_DIR, 'Translocation_TrueUnion_byCondition_heatmap_p10_fc1.png')
...
fig.text(0.5, (FIG_H-TOP_PAD*0.35)/FIG_H,
         f'True Protein Translocation — Chromatin & SN by Condition  (n = {n_prot})  [p < 0.10 | FC scale ±1]',
