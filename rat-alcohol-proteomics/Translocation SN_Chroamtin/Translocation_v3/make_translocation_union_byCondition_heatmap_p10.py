...
OUT_PDF  = os.path.join(SCRIPT_DIR, 'Translocation_Union_byCondition_heatmap_p10.pdf')
OUT_PNG  = os.path.join(SCRIPT_DIR, 'Translocation_Union_byCondition_heatmap_p10.png')
...
fig.text(0.5, (FIG_H-TOP_PAD*0.35)/FIG_H,
         f'Protein Translocation — Chromatin & SN by Condition  (n = {n_prot})  [p < 0.10]',
