"""
Chromatin fraction box-and-whisker plots — 3 panels, all 4 conditions
======================================================================
Panel 1: Aldh2  — Naïve / Intox / AW / PA  (Intox representative)
Panel 2: Acss2  — Naïve / Intox / AW / PA  (AW representative)
Panel 3: Otc    — Naïve / Intox / AW / PA  (PA representative)

Asterisks shown only for conditions with corrected p > 3.3 vs Naïve.
AW-M-3 excluded from AW replicates.

Outputs:
  Chromatin_BoxPlots.pdf / .png
"""
...
OUT_PDF    = os.path.join(SCRIPT_DIR, 'Chromatin_BoxPlots.pdf')
OUT_PNG    = os.path.join(SCRIPT_DIR, 'Chromatin_BoxPlots.png')

SHEET  = 'Chromatin'
PREFIX = 'Chrom'

PANELS = [
    dict(gene='Aldh2', title='Aldh2\n(Chromatin)'),
    dict(gene='Acss2', title='Acss2\n(Chromatin)'),
    dict(gene='Otc',   title='Otc\n(Chromatin)'),
]
