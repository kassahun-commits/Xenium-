"""
Chromatin fraction bar/dot plots — Acute Withdrawal, downregulated, 4 panels
=============================================================================
Panel 1: Tsc1    — Naive vs Acute Withdrawal  (List 491)
Panel 2: Rcc2    — Naive vs Acute Withdrawal  (List 491)
Panel 3: Tuba1a  — Naive vs Acute Withdrawal  (List 2)
Panel 4: Gphn    — Naive vs Acute Withdrawal  (List 2)
...
Outputs:
  Chromatin_AW_Down_BarPlots.pdf / .png
"""
...
OUT_PDF    = os.path.join(SCRIPT_DIR, 'Chromatin_AW_Down_BarPlots.pdf')
OUT_PNG    = os.path.join(SCRIPT_DIR, 'Chromatin_AW_Down_BarPlots.png')

SHEET  = 'Chromatin'
PREFIX = 'Chrom'

PANELS = [
    dict(gene='Tsc1',   cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Tsc1\n(Chromatin — AW)',
         source_list='List 491'),
    dict(gene='Rcc2',   cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Rcc2\n(Chromatin — AW)',
         source_list='List 491'),
    dict(gene='Tuba1a', cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Tuba1a\n(Chromatin — AW)',
         source_list='List 2'),
    dict(gene='Gphn',   cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Gphn\n(Chromatin — AW)',
         source_list='List 2'),
