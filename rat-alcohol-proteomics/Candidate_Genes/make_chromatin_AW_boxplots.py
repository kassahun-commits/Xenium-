"""
Chromatin AW upregulated box-and-whisker plots — 4 panels, all 4 conditions
============================================================================
Panel 1: Ncapg2  — Naïve / Intox / AW / PA  (List 189)
Panel 2: Etv6    — Naïve / Intox / AW / PA  (List 189)
Panel 3: H2afv   — Naïve / Intox / AW / PA  (List 152)
Panel 4: Ahcy    — Naïve / Intox / AW / PA  (List 152)
...
OUT_PDF    = os.path.join(SCRIPT_DIR, 'Chromatin_AW_BoxPlots.pdf')
OUT_PNG    = os.path.join(SCRIPT_DIR, 'Chromatin_AW_BoxPlots.png')
