"""
Chromatin fraction bar/dot plots — one panel per condition
===========================================================
Panel 1 (Intox): Aldh2   — Naive vs Intoxication
Panel 2 (Intox): Mthfd1  — Naive vs Intoxication
Panel 3 (AW):    Acss2   — Naive vs Acute Withdrawal
Panel 4 (PA):    Otc     — Naive vs Protracted Abstinence

Same purple pastel style as make_rep_dotplots.py.
AW-M-3 excluded from AW replicate columns.

Outputs:
  Chromatin_Condition_BarPlots.pdf / .png
"""
...
OUT_PDF    = os.path.join(SCRIPT_DIR, 'Chromatin_Condition_BarPlots.pdf')
OUT_PNG    = os.path.join(SCRIPT_DIR, 'Chromatin_Condition_BarPlots.png')

SHEET  = 'Chromatin'
PREFIX = 'Chrom'

PANELS = [
    dict(gene='Aldh2',  cond='Intox', cond_prefix='I',
         corr_col='Corrected',
         xlabel='Intox',
         title='Aldh2\n(Chromatin — Intox)'),
    dict(gene='Mthfd1', cond='Intox', cond_prefix='I',
         corr_col='Corrected',
         xlabel='Intox',
         title='Mthfd1\n(Chromatin — Intox)'),
    dict(gene='Acss2',  cond='AW',    cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Acss2\n(Chromatin — AW)'),
    dict(gene='Otc',    cond='PA',    cond_prefix='PA',
