"""
Chromatin fraction bar/dot plots — Acute Withdrawal, upregulated, 4 panels
===========================================================================
Panel 1: Ncapg2  — Naive vs Acute Withdrawal  (List 189)
Panel 2: Etv6    — Naive vs Acute Withdrawal  (List 189)
Panel 3: H2afv   — Naive vs Acute Withdrawal  (List 152)
Panel 4: Ahcy    — Naive vs Acute Withdrawal  (List 152)

Same purple pastel style as make_rep_dotplots.py.
AW-M-3 excluded from AW replicate columns.
Source list label shown in bottom-right corner of each panel.

Outputs:
  Chromatin_AW_BarPlots.pdf / .png
"""
...
OUT_PDF    = os.path.join(SCRIPT_DIR, 'Chromatin_AW_BarPlots.pdf')
OUT_PNG    = os.path.join(SCRIPT_DIR, 'Chromatin_AW_BarPlots.png')

SHEET  = 'Chromatin'
PREFIX = 'Chrom'

PANELS = [
    dict(gene='Ncapg2', cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Ncapg2\n(Chromatin — AW)',
         source_list='List 189'),
    dict(gene='Etv6',   cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Etv6\n(Chromatin — AW)',
         source_list='List 189'),
    dict(gene='H2afv',  cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='H2afv\n(Chromatin — AW)',
         source_list='List 152'),
    dict(gene='Ahcy',   cond='AW', cond_prefix='AW',
         corr_col='Corrected.1',
         xlabel='Acute\nWithdrawal',
         title='Ahcy\n(Chromatin — AW)',
         source_list='List 152'),
...
for ax, p in zip(axes, panels):
    ...
    # Source list label — bottom-right corner
    ax.text(0.97, 0.03, p['source_list'],
