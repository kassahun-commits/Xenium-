"""
All 12 volcano plots (4 compartments × Intox / AW / PA vs Naïve)
- AW-M-3 excluded from AW comparisons only
- Axes AUTO-SCALED per compartment (same style as the good-looking version)
- Same colors: pink UP, blue DOWN
"""
...
# Axes derived from Chromatin AW auto-scale — applied to ALL plots for consistency
XLIM = (-9.00, 9.74)
YLIM = (-0.5,  27.67)
...
with PdfPages(OUT) as pdf:
    for disp_label, sheet, prefix, n_pat, fmode in SHEETS:
        ...
        for cond_name in CONDITIONS:
            ...
            fig.text(0.5, 0.01,
                     f'|FC| > {FC_THRESH}  |  Corrected p > {CORR_THRESH}{aw_note}',
